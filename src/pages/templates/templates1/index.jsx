              ...
              <div className="container">
                <div className="div">
                  ...
                  <div className="flexcontainer">
                    ...
                    <p className="span-wrapper">
                      <span className="span">
                        Driven by our passion for animal welfare, we hand-select
                        each product and service with meticulous attention to
                        quality and sustainability. From nutritious food and
                        enriching toys to expert grooming and healthcare, every
                        offering is carefully curated to meet the unique needs
                    ...
                    <p className="span-wrapper">
                      <span className="span">
                        ...
                        to provide the best possible care for their furry family
                        members.
                        <br />
                      </span>
                    </p>
                  ...
                  <div className="div-6">
                    <div className="div-6">
                      ...
                      <p className="paragraph">
                        ...
                        <span className="text-wrapper-12">volutpat mollis</span>
                        <span className="text-wrapper-11">
                          at volutpat lectus velit, sed auctor. Porttitor fames
                          arcu quis fusce augue enim. Quis at habitant diam at.
                          Suscipit
                        </span>
                        <span className="text-wrapper-12">tristique risus</span>
                        <span className="text-wrapper-11">
                          , at donec. In turpis vel et quam imperdiet. Ipsum
                          molestie aliquet sodales id est ac volutpat. Eget quis
